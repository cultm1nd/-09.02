...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Окт 27 2024 г., 18:37
...
CREATE TABLE `posts` (
  ...
  `content` varchar(3000) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `user_id` bigint UNSIGNED NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
(5, '1730042342.jpg', 'qqq', 'qqq', 3, '2024-10-27 12:19:02', '2024-10-27 12:19:02'),
(6, '1730042418.jpg', 'aa', 'aa', 3, '2024-10-27 12:20:18', '2024-10-27 12:20:18'),
...
INSERT INTO `recipes` (`id_recipe`, `name`, `description`, `img`, `ingredients`, `calories`, `id_category`, `id_menu`, `created_at`, `updated_at`) VALUES
(1, 'as', 'dasasd', 'assda', 'sda', 231, 1, 0, NULL, NULL);
...
--
ALTER TABLE `posts`
  MODIFY `post_id` bigint UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;

--
-- AUTO_INCREMENT для таблицы `recipes`
--
ALTER TABLE `recipes`
  MODIFY `id_recipe` bigint UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
